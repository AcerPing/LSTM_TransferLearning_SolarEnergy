...
目前 repository governance 狀態為：Step 1 = COMPLETE、Step 2 = COMPLETE、Step 3 = COMPLETE、Step 4 = COMPLETE、Step 5A = COMPLETE、Step 5B = NOT COMPLETE。Step 5B 尚未完成，external archive transfer / verification 尚待完成；此狀態不重新開啟模型開發，亦不得據此宣稱 archive backup、Google Drive upload 或外接 HDD archive 已完成。
