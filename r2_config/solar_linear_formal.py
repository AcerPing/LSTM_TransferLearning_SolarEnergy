...
A2_APPROVED_UNTRACKED_BASELINE_RELATIVE_PATH = (
    "reports/governance/Solar_LSTM_A2_approved_untracked_baseline.csv"
)
A2_APPROVED_UNTRACKED_BASELINE_SHA256 = (
    "3c7382158a40b8cac4f78ecfbc862ca36fde50ca6205aa68d595d7896e71d2be"
)
A2_APPROVED_UNTRACKED_BASELINE_SCHEMA_VERSION = 1
A2_APPROVED_UNTRACKED_BASELINE_ID = "Solar_LSTM_A2_approved_untracked_v1"
A2_APPROVED_UNTRACKED_BASELINE_SOURCE_HEAD = (
    "424374766d7284c7927cbeb7f17f8a3aa8036d39"
)
A2_APPROVED_UNTRACKED_BASELINE_ROW_COUNT = 3467
A2_APPROVED_UNTRACKED_BASELINE_PROVENANCE_ANCHOR = (
    "42c1066a83a0d1497c398e6221d862eee248cd96"
)
